...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen">
      <LeftPanel
        tagline="Pronto para o próximo look?"
        sub="Entre na sua conta e explore as melhores opções de moda personalizadas para você."
      />
          ...
          >
            ...
            <div>
              ...
              <div className="mt-1.5 flex justify-end">
                <span className="cursor-pointer text-xs font-medium text-purple-600 hover:underline">
                  Esqueci minha senha
                </span>
              </div>
            </div>
